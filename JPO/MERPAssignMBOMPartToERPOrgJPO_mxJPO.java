...
//-------------------
   ...
   */
  public MapList getListOfItemsAndOrgsToAssign (Context context, String[] args) throws Exception
  {
...
//		MERPMessage.MERPSendNotice(context, putECOResult, baseERPiniMap);
  ...
  // end getListOfItemsAndOrgsToAssign()
	...
	public MapList getListOfItemsAndOrgsToAssignMain(Context context, String[] args, Map baseERPiniMap, Map erp_objectNamesMap) throws FrameworkException
	{
		/*
...
//String[] availableERPOrgsArr = strAvailableERPOrgs.split("|");
		...
		for (int i=0; i< destOrgsArr.length; i++)
		{
			if (!availableERPOrgsVect.contains(destOrgsArr[i]))
			{
				invalidDestOrgs += destOrgsArr[i];
				invalidDestOrgs += ",";
			}
		}		
